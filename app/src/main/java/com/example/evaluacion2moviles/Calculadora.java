package com.example.evaluacion2moviles;
...
import static com.example.evaluacion2moviles.MainActivity.operacion;
import static com.example.evaluacion2moviles.MainActivity.resultado;
import static com.example.evaluacion2moviles.MainActivity.contSuma;
import static com.example.evaluacion2moviles.MainActivity.contResta;
import static com.example.evaluacion2moviles.MainActivity.contMultiplicacion;
import static com.example.evaluacion2moviles.MainActivity.contDivision;
import static com.example.evaluacion2moviles.MainActivity.contPiz;
import static com.example.evaluacion2moviles.MainActivity.contPde;
import static com.example.evaluacion2moviles.MainActivity.contPunto;
        ...
        if(resultado.length()<= 0){
            if(operacion.length() > 0){
                ...
                if(BuscarOperador(ultimoCarac)){
                    Toast.makeText(this, "Error, borre un operador", Toast.LENGTH_SHORT).show();
                } else{
                    operacion = operacion + "+";
                    contSuma++;
                    txvOperacion.setText(operacion);
